<x-layout.landing title="Pilih Jenis Voting">
    ...
    <section id="info-card"
        ...
        <div class="space-y-3 md:space-y-4 mb-6 md:mb-10">
            <div class="flex flex-col md:flex-row md:items-center stagger-item">
                ...
                <span class="font-semibold text-base md:text-lg">Jaiman Cawisono Gunarto</span>
            </div>
            <div class="flex flex-col md:flex-row md:items-center stagger-item">
                <span class="text-tertiary-300 w-20 font-medium text-sm md:text-base">Fakultas</span>
                <span class="font-semibold text-lg w-3 hidden md:inline">:</span>
                <span class="font-semibold text-base md:text-lg">Ilmu Komputer</span>
            </div>
            <div class="flex flex-col md:flex-row md:items-center stagger-item">
                <span class="text-tertiary-300 w-20 font-medium text-sm md:text-base">NPM</span>
                <span class="font-semibold text-lg w-3 hidden md:inline">:</span>
                <span class="font-semibold text-base md:text-lg font-mono">1986122504</span>
            </div>
        </div>
    ...
    <section class="max-w-7xl mx-auto mt-8 md:mt-12 px-4 md:px-0">
        @forelse ($types as $type)
            <div
                class="bg-white border-[3px] border-primary-600 rounded-[20px] md:rounded-[30px] p-6 md:p-12 flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10 shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer voting-type-card mb-6 md:mb-8">
                ...
                <div class="flex-1 flex justify-start md:justify-end z-10 w-full md:w-auto">
                    <a href="#"
                        class="bg-primary-600 text-white px-6 py-3 rounded-full hover:bg-primary-800 transition-all shadow-md w-full md:w-auto text-center">Pilih
                        {{ $type->name }}</a>
                </div>
            </div>
        @empty
            <div
                class="bg-white border-[3px] border-primary-600 rounded-[20px] md:rounded-[30px] p-6 md:p-12 flex flex-col md:flex-row items-center gap-6 md:gap-10 shadow-lg mb-8">
                <div class="flex-1 z-10 w-full">
